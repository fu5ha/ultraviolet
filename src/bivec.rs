...
/// to the result of the outer (wedge) product of two vectors, i.e.
...
/// you obtain a bivector by taking the outer product of two vectors, the positive direction of rotation
/// is defined as the one that *brings the first vector closer to the second*. For example, a bivector
/// created by taking the outer product `x ∧ y` of the x and y basis vectors will create a unit
